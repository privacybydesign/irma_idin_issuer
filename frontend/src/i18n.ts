        ...
        resources: {
            en: {
                translation: {
                    ...
                    index_explanation: "You can log in here via your bank, in the usual way. Your bank will then send, with your permission, some attributes (your name, address, etc.) back to this website. You can then load these attributes into your Yivi app.",
                    ...
                    enroll_received_attributes: "The following attributes were provided by your bank:",
                    enroll_derived_attributes: "The following attributes were derived from them:",
                    ...
                    enroll_clicktoload: "Click the Load Attributes button to load these into your Yivi app.",
                    ...
                    done_text1: "Congratulations! Your attributes have now been loaded into your Yivi app. They are now visible there.",
                    done_text2: "You can now use them on any website that accepts these attributes.",
                    done_text3: "Click the button below to test this; it will display your date-of-birth attribute.",
            ...
            nl: {
                translation: {
                    ...
                    index_explanation: "U kunt hier inloggen via uw bank, op de gebruikelijke wijze. Uw bank stuurt dan, na uw toestemming, enkele attributen (uw naam, adres, etc.) terug naar deze website. Vervolgens kunt u deze attributen in uw Yivi app laden.",
                    ...
                    enroll_clicktoload: "Klik de Laad attributen knop om deze attributen in uw Yivi app te laden.",
                    ...
                    done_text1: "Gefeliciteerd! Uw attributen zijn nu in uw Yivi app geladen. Daar zijn ze nu zichtbaar.",
